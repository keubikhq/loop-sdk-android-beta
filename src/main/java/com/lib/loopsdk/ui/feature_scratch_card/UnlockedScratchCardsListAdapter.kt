...
class UnlockedScratchCardsListAdapter(
    private val list: ArrayList<AllUnlockedScratchCardsDto.Data.ScratchCard> = arrayListOf(),
    ...
    fun addData(data: List<AllUnlockedScratchCardsDto.Data.ScratchCard>) {
    ...
    inner class ViewHolder(
        ...
        fun bind(item: AllUnlockedScratchCardsDto.Data.ScratchCard) {
    ...
    interface Interaction {
        fun onPlayNowButtonClicked(position: Int, scratchCard: AllUnlockedScratchCardsDto.Data.ScratchCard)
    }
}