...
import com.lib.loopsdk.databinding.ListItemIntroSlideLongBinding

class IntroSliderLongAdapter(
    ...
    override fun isViewFromObject(view: View, `object`: Any): Boolean {
        return view == (`object` as ListItemIntroSlideLongBinding).root
    }

    override fun instantiateItem(container: ViewGroup, position: Int): Any {
        val binding = ListItemIntroSlideLongBinding.inflate(
    ...
    override fun destroyItem(container: ViewGroup, position: Int, `object`: Any) {
        container.removeView((`object` as ListItemIntroSlideLongBinding).root)
    }
