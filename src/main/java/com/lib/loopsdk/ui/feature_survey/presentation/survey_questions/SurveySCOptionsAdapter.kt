...
class SurveySCOptionsAdapter(private val options: List<SurveyQuestionsDto.Data.Question.Option>,
                             private val currentQuestionPostion: Int,
                             private val listener: SCSelectorListener
) : RecyclerView.Adapter<SurveySCOptionsAdapter.MyVH>(){

    inner class MyVH(val view: ListItemSurveySinglechoiceBinding) : RecyclerView.ViewHolder(view.root) {
        fun bind(
            view: View,
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyVH {
        val view =
            ListItemSurveySinglechoiceBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        return MyVH(view)
    }
