...
import com.lib.loopsdk.databinding.ActivitySpinWheelListBinding
...
class SpinWheelListActivity : BaseActivity() {

    private lateinit var binding:ActivitySpinWheelListBinding
    private lateinit var viewModel: SpinWheelListViewModel
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_spin_wheel_list)
        ...
        viewModel = ViewModelProvider(this)[SpinWheelListViewModel::class.java]
        setupViewPager()
        ...
        viewModel.fragmentToActivityEventFlow.onEach {
            when(it){
                is SpinWheelListViewModel.Event.OnPointsReceived -> {
    ...
    private fun setupViewPager() {
        ...
        tabFragmentsList.add(AvailableSpinWheelFragment())
        tabFragmentsList.add(UnlockedSpinWheelFragment())
